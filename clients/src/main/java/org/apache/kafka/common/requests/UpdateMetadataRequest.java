            ...
            try {
                ...
                if (updateMetadataRequest == null) {
                    ...
                    updateMetadataRequest =
                        new UpdateMetadataRequest(version, controllerId, controllerEpoch, partitionStates, liveBrokers);
                ...
                for (Broker broker : liveBrokers) {
                    ...
                    if (version == 0) {
                        ...
                        for (EndPoint endPoint : broker.endPoints) {
                            ...
                            if (version >= 3) endPointData.set(LISTENER_NAME_KEY_NAME, endPoint.listenerName.value());
